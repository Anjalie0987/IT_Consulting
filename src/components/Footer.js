                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            {['About Us', 'What We Do', 'Industries', 'Insights', 'Careers'].map((link) => (
                                <li key={link}>
                                    <a href="#" className="text-sm text-slate-400 hover:text-white transition-colors duration-300 inline-block relative group">
                                        {link}
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            {['Contact Us', 'Locations', 'Case Studies', 'Privacy Policy', 'Terms of Use'].map((link) => (
                                <li key={link}>
                                    <a href="#" className="text-sm text-slate-400 hover:text-white transition-colors duration-300 inline-block relative group">
                                        {link}
                                        <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-500 transition-all duration-300 group-hover:w-full"></span>
