...
export default function EmergingDigitalHero() {
    return (
        <section className="relative w-full min-h-[50vh] md:min-h-[60vh] lg:min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#0E0E0E]">
            ...
            <div className="absolute inset-0 z-0">
                <img
                    src="/bg/whatWeDo.jpg"
                    alt="Emerging & Digital-First Domains Background"
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-24 text-center">
                ...
                >
                    Emerging & Digital-First Domains
                </motion.h1>
                ...
                <motion.div
                    ...
                    className="h-[2px] bg-blue-600 mx-auto mt-6"
                ></motion.div>
                ...
                >
                    Supporting startups and digital-native businesses with scalable technology, modern platforms, and future-ready strategies.
                </motion.p>
