...
export default function CommercialConsumerHero() {
    return (
        <section className="relative w-full min-h-[50vh] md:min-h-[60vh] lg:min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#0E0E0E]">
            ...
            <div className="absolute inset-0 z-0">
                <img
                    src="/bg/whatWeDo.jpg"
                    alt="Commercial & Consumer Industries Background"
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-24 text-center">
                ...
                >
                    Commercial & Consumer Industries
                </motion.h1>
                ...
                >
                    Enabling growth, efficiency, and customer-centric innovation across dynamic commercial and consumer markets.
                </motion.p>
